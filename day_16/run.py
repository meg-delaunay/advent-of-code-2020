...
# sum_invalid = sum(invalid_numbers)
# print(sum_invalid)
...
#         for name, rule_numbers in rules.items():
...
#         matching_rules = []
#         n = int(n)
#         for rule_name, rule_numbers in rules.items():
#             if n in rule_numbers:
#                 matching_rules.append(rule_name)
#         print(n, matching_rules)

#         if len(matching_rules) == 1:
#             ticket_order[i] = matching_rules[0]
#         matches[n] = matching_rules


# get the first number in all. see which rules it matches.
# get the second number in each rule, etc. 

# need rules to actually be: 
#{class: [1,2,3,5,7]}
#print(matches)